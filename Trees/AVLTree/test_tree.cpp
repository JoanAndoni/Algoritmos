...
void menu()
{
    ...
    bool found = false;
	/*
	int preset_data[100000];
	read(preset_data);
    int preset_size = 100000;
	*/
	int preset_data[] = { 10, 8, 13, 4, 1, 2 };
    ...
    while (ans != 'q')
    {
        ...
        switch (ans)
        {
            ...
            case 's':
				...
				//std::cout << "with the height:  " << tree.searchHeight(number) << std::endl;
                break;
            case 'r':
